			...
			<Wrapper>
				...
				<Div className='mb-10 relative'>
					...
					<div className='text-[16px] 2xl:text-[20px] leading-[24px] 2xl:leading-[32px] text-black text-center max-w-[1000px] mx-auto'>
						You have need for new website or webshop, or you have outdated
						website and you want something new.{' '}
						<span className='font-semibold'>
							My team and I is here for you!
						</span>{' '}
						Leave some of your conntact and your need, and I will personaly
						conntact you in short time.
					</div>
				</Div>
				{/* SECTION HEADING END */}
