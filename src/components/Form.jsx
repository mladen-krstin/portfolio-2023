			...
			>
				...
				<div className='grid grid-cols-1 md:grid-cols-2 gap-7'>
					...
					<div className='flex flex-col gap-2'>
						...
						<input
							...
							id='name'
							type='text'
							className='h-[64px] bg-white outline-none border-none rounded-lg text-black px-4'
							required
							autoComplete='off'
							onChange={onChange}
						/>
				...
				<div className='flex flex-col gap-2'>
					<label
						...
						className='text-[16px] text-black uppercase'
					>
						Please tell us a bit about your new project
						<sup>*</sup>
					</label>
					<textarea
						name='message'
						className='h-[162px] bg-white outline-none border-none rounded-lg text-black p-4 resize-none'
						required
						onChange={onChange}
					/>
				</div>
				...
				{/* SUBMIT BUTTON */}
				<button className='bg-[#111111] h-[64px] max-w-[585px] text-lg font-semibold rounded-lg transition-transform active:scale-[0.95]'>
					Send Contact Request Now {status}
				</button>
				{/* SUBMIT BUTTON */}
			</form>
		</Div>
